        ...
        function add_item_class(type_of_append,page_id)
        {
            ...
            case 'button':
                ...
                $('#'+page_id+' [class^=parentElement]').each(function(){ 
                 ...
                 var item= '<div class="parentElement btn" data-toggle="popover" ondblclick="my_button_change('+dd+')" id="'+page_id+'_parentElement'+(id+1)+'" title="Drag and drop to change position and click to change text!"><p>Click !'+(id+1)+'</p></div>';
                 $("#"+page_id).append($(item)); 
                 //alert(item);
