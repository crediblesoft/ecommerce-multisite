...
<!--            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: #DFDFDF;">                
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                
                ...
                <div class="  col-sm-12 col-xs-12 col-lg-6 col-md-6 col-md-offset-3 col-lg-offset-3">
                    <input class="form-control" type="text" name="" id="botton_link<?php echo $divid;?>" value="<?php echo $link; ?>" Placeholder="(http://www.example.com/)" >
                </div>
                    ...
                    function changein_botton()
                        {
                            ...
                            $("#"+divid+" a").html(data_id);
                            var botton_link=$("#botton_link"+divid).val();
                            //$("#"+divid+" a").attr("href",botton_link);
                            $("#"+divid+" a").attr("title",botton_link);
