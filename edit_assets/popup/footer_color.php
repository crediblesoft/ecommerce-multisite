...
<div  id="<?php echo $pp_name;?>" state="disabled notRotatable" class="<?php echo $daynamiceresponcivepopup;?>" >
        ...
        <div class="row">
            <div class="col-lg-12" style="background-color: #DFDFDF;">                
                <div class="col-lg-12 text-center"><h3 >Footer  Edit</h3></div>
            </div>            
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <?php  $backround="#".$pp_name."backround";?>
                            <input type="color" class="input-sm" id="<?php echo 'footer_backround';?>" name="<?php echo $pp_name.'backround';?>" onchange='abc(".prod_c_container","background-color",<?php echo '"'.$backround.'"';?>)' value="<?php echo getcss('111', '.prod_c_container' , 'background-color');?>"  >
                        </td>
                    </tr>
    ...
    <div class="col-lg-offset-1 col-lg-4 col-md-6 col-sm-6 col-xs-6 text-center">               
               <button class="pbb btn-block" onClick='savefullpage1()'>
 ...
 function   savefullpage1()
    {
        ...
        var sessionid=$("#session").val();
        var fild=".footer";
        var elimen=$("#footer_backround").val();
       $.ajax({
      type: "POST",
