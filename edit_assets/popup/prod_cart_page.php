...
<div  id="<?php echo $pp_name;?>" state="disabled notRotatable" class="<?php echo $daynamiceresponcivepopup;?>" >
        ...
        <div class="row">
            <?php echo topheaderpopupsaveclose('d_off("#'.$pp_name.'")','savefullpage()','Product Cart Edit form  ');?>
<!--            <div class="col-lg-12" style="background-color: #DFDFDF;">                
                <div class="col-lg-12 text-center"><h3 >Product Cart Edit form</h3></div>
            </div>            -->
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <?php  $backround="#".$pp_name."backround";?>
                            <input type="color" class="input-sm" id="<?php echo $pp_name.'backround';?>" name="<?php echo $pp_name.'backround';?>" onchange='abc(".prod_c_container","background-color",<?php echo '"'.$backround.'"';?>)' value="<?php echo getcss('111', '.prod_c_container' , 'background-color');?>"  >
                        </td>
                    </tr>
                    <tr> <?php  $s_name_f_size="#".$pp_name."s_name_f_size";  
                         $s_name_c="#".$pp_name."s_name_c";?>
                        <td colspan="3"><b>Title Name</b>
                        <?php  $backround="#".$pp_name."titel_backround";?>
                            <input type="color" class="input-sm" id="<?php echo $pp_name.'titel_backround';?>" name="<?php echo $pp_name.'titel_backround';?>" onchange='abc(".prod_cart_titel","background-color",<?php echo '"'.$backround.'"';?>)' value="<?php echo getcss('111', '.prod_cart_titel' , 'background-color');?>"  >
                        </td>                        
                        <td style="float: right">
                 
                            <input type="number" class="input-sm" id="<?php echo $pp_name.'s_name_f_size';?>"  name="<?php echo $pp_name.'s_name_f_size';?>" onchange='abc(".prod_cart_titel","font-size",<?php echo '"'.$s_name_f_size.'"';?>)' value="<?php echo intval(getcss('111' , '.prod_cart_titel' , 'font-size'));?>" >
                            <input type="color"  class="input-sm" id="<?php echo $pp_name.'s_name_c';?>" name="<?php echo $pp_name.'s_name_c';?>" onchange='abc(".prod_cart_titel","color",<?php echo '"'.$s_name_c.'"';?>)' value="<?php echo getcss('111', '.prod_cart_titel' , 'color');?>"  >                        
                     ...
                     <tr>
                        ...
                        <td style="float: right">
                         ...
                         $s_detail_c="#".$pp_name."s_detail_c";?>
                             <?php /*?><input type="number" class="input-sm" id="<?php echo $pp_name.'s_detail_f_size';?>"  name="<?php echo $pp_name.'s_detail_f_size';?>" onchange='abc(".prod_cart_detail","font-size",<?php echo '"'.$s_detail_f_size.'"';?>)' value="<?php echo intval(getcss('111' , '.prod_cart_detail' , 'font-size'));?>" ><?php */?>
                            <input type="color"  class="input-sm" id="<?php echo $pp_name.'s_detail_c'?>" name="<?php echo $pp_name.'s_detail_c'?>" onchange='abc(".prod_cart_detail","color",<?php echo '"'.$s_detail_c.'"';?>)' value="<?php echo getcss('111', '.prod_cart_detail' , 'color');?>"  > 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="float: right"> 
                         ...
                         $s_price_c="#".$pp_name."s_price_c";?>
                            <input type="number" class="input-sm" id="<?php echo $pp_name.'s_price_f_size';?>"  name="<?php echo $pp_name.'s_price_f_size';?>" onchange='abc(".prod_c_price","font-size",<?php echo '"'.$s_price_f_size.'"';?>)' value="<?php echo intval(getcss('111' , '.prod_c_price' , 'font-size'));?>" >
                            <input type="color"  class="input-sm" id="<?php echo $pp_name.'s_price_c';?>" name="<?php echo $pp_name.'s_price_c';?>" onchange='abc(".prod_c_price","color",<?php echo '"'.$s_price_c.'"';?>)' value="<?php echo getcss('111', '.prod_c_price' , 'color');?>"  >                        
                        </td>
                    </tr>
                   ...
                   <tr>
                        ...
                        <td style="float: right">
                         ...
                         $sd_price_c="#".$pp_name."sd_price_c";?>
                            <input type="number" class="input-sm" id="<?php echo $pp_name.'sd_price_f_size';?>"  name="<?php echo $pp_name.'sd_price_f_size';?>" onchange='abc(".prod_c_d_price","font-size",<?php echo '"'.$sd_price_f_size.'"';?>)' value="<?php echo intval(getcss('111', '.prod_c_d_price' , 'font-size'));?>" >
                            <input type="color"  class="input-sm" id="<?php echo $pp_name.'sd_price_c';?>" name="<?php echo $pp_name.'sd_price_c';?>" onchange='abc(".prod_c_d_price","color",<?php echo '"'.$sd_price_c.'"';?>)' value="<?php echo getcss('111', '.prod_c_d_price' , 'color');?>"  >                        
                        </td>
                    </tr>                   
                    
                     <tr>
                        <td colspan="3"><b>Continue Shopping Button</b></td>                        
                        <td style="float: right">
                             <?php  $s_bottun_t_c="#".$pp_name."s_bottun_t_c";  
                         $s_bottun_b_c="#".$pp_name."s_bottun_b_c";?>
                            <input type="color" class="input-sm" id="<?php echo $pp_name.'s_bottun_t_c';?>"  name="<?php echo $pp_name.'s_bottun_t_c';?>" onchange='abc(".cart_btn","color",<?php echo '"'.$s_bottun_t_c.'"';?>)' value="<?php echo getcss('111', '.cart_btn' , 'color');?>" >
                            <input type="color"  class="input-sm" id="<?php echo $pp_name.'s_bottun_b_c'?>" name="<?php echo $pp_name.'s_bottun_b_c'?>" onchange='abc(".cart_btn","background",<?php echo '"'.$s_bottun_b_c.'"';?>)' value="<?php echo getcss('111', '.cart_btn' , 'background');?>"  >                        
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3"><b>Place Order Button</b></td>                        
                        <td style="float: right">
                             <?php  $s_bottun_th_c="#".$pp_name."s_bottun_th_c";  
                         $s_bottun_bh_c="#".$pp_name."s_bottun_bh_c";?>
                            <input type="color" class="input-sm" id="<?php echo $pp_name.'s_bottun_th_c';?>"  name="<?php echo $pp_name.'s_bottun_th_c';?>" onchange='abc(".cart_btn_po","color",<?php echo '"'.$s_bottun_th_c.'"';?>)' value="<?php echo getcss('111', '.cart_btn_po' , 'color');?>" >
                            <input type="color"  class="input-sm" id="<?php echo $pp_name.'s_bottun_bh_c'?>" name="<?php echo $pp_name.'s_bottun_bh_c'?>" onchange='abc(".cart_btn_po","background",<?php echo '"'.$s_bottun_bh_c.'"';?>)' value="<?php echo getcss('111', '.cart_btn_po' , 'background');?>"  >                        
                        </td>
                    </tr>
    ...
    <div class="col-lg-12 text-center">                
               <button class="pbb btn-block" onClick="load_popup('#view_prod','#prod_bootstrap_cart_page')">Edit Bootstrap</button>
            </div>
    <br><?php */?>
