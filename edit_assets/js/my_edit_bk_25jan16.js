  ...
  function add_item_id1(pageno)
        {
             ...
             $(fullpageid+' [class^=parentElement]').each(function(){ 
                 ...
                 var ind = $(this).index();
                  ...
                  divall_data+="<div id='"+pageid+"parentElement"+(ind)+"' ondblclick='my_button_change("+dd+")' class='parentElement btn' title='Drag and drop to change position and click to change text!' data-toggle='popover' style='"+styl+"'><a href='"+link+"' class='btn'>"+data+"</a></div>";
