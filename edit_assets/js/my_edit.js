...
//                   currentpagetitleprevposition[1]=pos.top;
//                   currentpagetitleprevposition[0]=pos.left;
//                   
//                }
//            });
...
//    });
    ...
    $(".social_m li").popover({
      content:"Change only visualization from here for other changes\n\
                 <a href='"+base_url+"profile' target='_blank' title=' double click for edit social Media link'>click here</a>, and for change positon double click and drag & drop'.",
        title:"Social Media",
        placement:"top",
        html:true,
        delay:{hide:1000},
