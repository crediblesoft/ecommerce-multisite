    ...
    //for botton
     $(document).on("click", ".parentElement", function(event){
       ...
       var data=$("#"+divid+" p").html();       
        ...
        var que="?divid="+divid+"&BASE_URL="+BASE_URL+"&user_id="+user_id+"&data="+encodeURIComponent(data);       
       //alert($("#"+divid+" p").html());
  ...
  function add_item_id1(pageno)
        {
             ...
             $(fullpageid+' [class^=parentElement]').each(function(){ 
                 ...
                 var ind = $(this).index();
                  ...
                  divall_data+="<div id='"+pageid+"parentElement"+(ind)+"' ondblclick='my_button_change("+dd+")' class='parentElement btn' title='Drag and drop to change position and click to change text!' data-toggle='popover' style='"+styl+"'><p>"+data+"</p></div>";
...
//    });
    ...
    $("#SaveAddItemsli").popover({
        content:"click to save Add items.",
        title : 'Save items',
        html:true,
        placement:"bottom",
        trigger:"hover"
