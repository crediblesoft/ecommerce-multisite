...
class Transaction extends MY_Controller {
    ...
    function __construct()
    {
        parent::__construct();
        $this->_valid_admin();
        $this->_screen_security_admin('Manage Transaction');
        $this->userid=$this->session->userdata(ADMIN_SESS.'user_id');
    }
    
    public function index(){
        $comment1=array('val'=>'t.id,t.status,t.price,t.date,t.trans_id,t.payment_for,t.order_id,u.username,u2.username as user2','table'=>'transaction as t','where'=>array(),'minvalue'=>'','group_by'=>'t.id','start'=>'','orderby'=>'t.id','orderas'=>'DESC');
        $multijoin1=array(
...
//        $comment2=array('val'=>'t.id,t.status,t.price,t.date,t.trans_id,t.payment_for,t.order_id,u.username','table'=>'transaction as t','where'=>array('t.payment_for'=>'bidproduct'),'minvalue'=>'','group_by'=>'t.id','start'=>'','orderby'=>'t.id','orderas'=>'DESC');
//        $multijoin2=array(
//            array('table'=>'order_detail_form as odf','on'=>'odf.trans_id=t.trans_id','join_type'=>'left'),
//            array('table'=>'user_Info as u','on'=>'odf.buyerid=u.id','join_type'=>'left'),
//        );
//        $table1=$this->common->multijoin($comment2,$multijoin2);
//        echo "<pre>";
//        print_r($table1); exit;
        $config = array();
    ...
    public function search(){
        ...
        if($searchby=='paymentfor'){
            ...
            $comment1=array('val'=>'t.id,t.status,t.price,t.date,t.trans_id,t.payment_for,t.order_id,u.username,u2.username as user2','table'=>'transaction as t','where'=>array(),'minvalue'=>'','group_by'=>'t.id','start'=>'','orderby'=>'t.id','orderas'=>'DESC',"like"=>array("likeon"=>"t.trans_id","likeval"=>$val));
            $resp=$this->searchbyother(trim($val),$comment1,$searchby);
        }
		
		else if($searchby=='amount'){
            $comment1=array('val'=>'t.id,t.status,t.price,t.date,t.trans_id,t.payment_for,t.order_id,u.username,u2.username as user2','table'=>'transaction as t','where'=>array('t.price'=>$val),'minvalue'=>'','group_by'=>'t.id','start'=>'','orderby'=>'t.id','orderas'=>'DESC',"like"=>array());
            $resp=$this->searchbyother(trim($val),$comment1,$searchby);
        }
		...
		if($table['res'] || $table3['res'])
		{
				...
				if($table3['res'])
				{
					...
					$comment2=array('val'=>'t.id,t.status,t.price,t.date,t.trans_id,t.payment_for,t.order_id,u.username,u2.username as user2','table'=>'transaction as t','where'=>array(),'minvalue'=>'','group_by'=>'','start'=>'','orderby'=>'t.id','orderas'=>'DESC','in'=>'t.trans_id','in_value'=>$trans_ids);
					$resp=$this->searchbymore(trim($val),$comment2,$searchby);
			...
			$multijoin1=array(
				...
				array('table'=>'user_Info as u','on'=>'bid.user_id=u.id','join_type'=>'left'),
			);
			$table=$this->common->multijoin_with_like($comment1,$multijoin1);
			...
			if($table['res'] || $table3['res'])
			{
				...
				$comment2=array('val'=>'t.id,t.status,t.price,t.date,t.trans_id,t.payment_for,t.order_id,u.username,u2.username as user2','table'=>'transaction as t','where'=>array(),'minvalue'=>'','group_by'=>'','start'=>'','orderby'=>'t.id','orderas'=>'DESC','in'=>'t.trans_id','in_value'=>$trans_ids,"like"=>array("likeon"=>"u2.username","likeval"=>$val));
				$resp=$this->searchbymore(trim($val),$comment2,$searchby);
