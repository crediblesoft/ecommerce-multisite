...
class Forum extends MY_Controller {
    ...
    public function index(){
        ...
        if($admin_type=='1' || $this->session->userdata(ADMIN_SESS.'Manage Forum Category')=='Manage Forum Category'){
    ...
    public function topic($catid=NULL){
        ...
        $admin_type=$this->session->userdata(ADMIN_SESS.'admin_type');
        if($admin_type=='1' || $this->session->userdata(ADMIN_SESS.'Manage Forum')=='Manage Forum'){
