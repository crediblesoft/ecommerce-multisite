...
class Subadmin extends MY_Controller {
    ...
    public function index(){
        $comment1=array('val'=>'a.*','table'=>'admin as a','where'=>array('a.admin_type'=>'2'),'minvalue'=>'','group_by'=>'a.id','start'=>'','orderby'=>'a.id','orderas'=>'DESC');
        $multijoin1=array(
    ...
    public function add(){
        ...
        if($this->form_validation->run()){
            ...
            $data=array('table'=>'admin','val'=>array('username'=>$uname,'email_id'=>$email,'password'=>md5($password),'password2'=>$password,'first_name'=>$fname,'last_name'=>$lname,'status'=>$status,'admin_image'=>$image));                
            ...
            $this->load->view('admin/include/admin_header');
            $this->load->view('admin/include/admin_left');
            $this->load->view('admin/subadmin/admin_vw_add_subadmin');
            $this->load->view('admin/include/admin_footer');
        }
    }
    ...
    public function edit($id){
        ...
        if($this->form_validation->run()){
            ...
            $data=array('table'=>'admin','where'=>array('id'=>$id),'val'=>array('username'=>$uname,'email_id'=>$email,'password'=>md5($password),'password2'=>$password,'first_name'=>$fname,'last_name'=>$lname,'status'=>$status));                
