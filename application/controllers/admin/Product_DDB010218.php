...
class Product extends MY_Controller {
    ...
    public function index(){
        $comment1=array('val'=>'p.id,p.prod_name,p.prod_price,p.no_of_Prod,p.date,p.admin_status,p.taxable_status,cat.category,u.username,sum(o.quantity) as sold','table'=>'product as p','where'=>array('bid_status'=>'0'),'minvalue'=>'','group_by'=>'p.id','start'=>'','orderby'=>'p.id','orderas'=>'DESC');
        $multijoin1=array(  
    ...
    public function details($id){
        ...
        $comment1=array('val'=>'p.id,p.prod_name,p.date,p.weight,p.weight_unit,p.length,p.width,p.height,p.die_unit,p.no_of_prod,p.pord_detail,p.prod_img,p.prod_price,p.status,p.admin_status,p.taxable_status,p.local_shipping,u.username,u.id as userid,u.type_Of_User,cat.category','table'=>'product as p','where'=>array('p.id'=>$id,'bid_status'=>'0'),'minvalue'=>'','group_by'=>'','start'=>'','orderby'=>'p.id','orderas'=>'DESC');
        $multijoin1=array(  
            array('table'=>'category as cat','on'=>'p.category=cat.id','join_type'=>''),
            array('table'=>'user_Info as u','on'=>'p.user_id=u.id','join_type'=>'left'),
        );  
    ...
    public function search(){
        ...
        if($searchby=='seller'){
            ...
            $comment1=array('val'=>'p.id,p.prod_name,p.prod_price,p.no_of_Prod,p.taxable_status,p.date,p.admin_status,cat.category,u.username,sum(o.quantity) as sold','table'=>'product as p','where'=>array('bid_status'=>'0'),'minvalue'=>'','group_by'=>'p.id','start'=>'','orderby'=>'p.user_id','orderas'=>'DESC',"like"=>array("likeon"=>"u.username","likeval"=>$val));
            ...
            $comment1=array('val'=>'p.id,p.prod_name,p.prod_price,p.no_of_Prod,p.date,p.taxable_status,p.admin_status,cat.category,u.username,sum(o.quantity) as sold','table'=>'product as p','where'=>$where,'minvalue'=>'','group_by'=>'p.id','start'=>'','orderby'=>'p.user_id','orderas'=>'DESC',"like"=>array());
            $resp=$this->searchbyother(trim($val),$comment1,$searchby);
        }
            ...
            $comment1=array('val'=>'p.id,p.prod_name,p.prod_price,p.no_of_Prod,p.date,p.taxable_status,p.admin_status,cat.category,u.username,sum(o.quantity) as sold','table'=>'product as p','where'=>array('bid_status'=>'0'),'minvalue'=>'','group_by'=>'p.id','start'=>'','orderby'=>'p.user_id','orderas'=>'DESC',"like"=>array("likeon"=>"prod_name","likeval"=>$val));
            $resp=$this->searchbyother(trim($val),$comment1,$searchby);
