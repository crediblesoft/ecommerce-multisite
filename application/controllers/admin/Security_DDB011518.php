...
class Security extends MY_Controller {
    ...
    public function assign_screen_security(){
        ...
        if ($resp['roles']['res']) {
        $comment1="SELECT s.id as security_id,v.screen_name,v.screen_description,r.role_name,r.id as role_id,v.id as val_id,s.status as security_status from valid_screens v,security_roles r,screen_security s where s.role_id=r.id and s.screen_id=v.id and s.role_id=".$resp['roles']['rows'][0]->id;
...
public function getrolelist($roleidval=0){
        ...
        $comment1="SELECT s.id as security_id,v.screen_name,v.screen_description,r.role_name,r.id as role_id,v.id as val_id,s.status as security_status from valid_screens v,security_roles r,screen_security s where s.role_id=r.id and s.screen_id=v.id and s.role_id=".$roleidval;
