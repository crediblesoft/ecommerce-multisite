...
class Dashboard extends MY_Controller {
    ...
    public function index(){
        ...
        $data=array('val'=>'v.screen_name,s.modifiable,s.enable','table'=>'admin as a','where'=>array('a.admin_type'=>'2','a.id'=>$this->userid,'v.status'=>'Active','s.status'=>'Active','r.status'=>'Active'),'minvalue'=>'','start'=>'','orderby'=>'a.id','orderas'=>'DESC');
        $multijoin1=array(
        ...
        foreach($valid_screens['rows'] as $screen){
          ...
          $key_name2=ADMIN_SESS.$screen->screen_name.'_modifiable';
          $this->session->set_userdata($key_name2,$screen->modifiable);
          $key_name3=ADMIN_SESS.$screen->screen_name.'_enable';
          $this->session->set_userdata($key_name3,$screen->enable);
        }
