...
class Sellerprofile extends MY_Controller {
    ...
    {   
         $comment1=array('val'=>'u.address1,s.state,u.city,u.zip,u.id,u.username,u.f_name,u.l_name,u.type_Of_User,u.profile_Pic,si.business_name,si.address as bus_address,si.zip as bus_zip,si.city as bus_city,get_state_name(si.state) as bus_state,GROUP_CONCAT(bt.category SEPARATOR ",") as business_type','table'=>'user_Info as u','where'=>array("u.username"=>$username),'minvalue'=>'','group_by'=>'u.id','start'=>'','orderby'=>'u.id','orderas'=>'DESC');
            $multijoin1=array(
