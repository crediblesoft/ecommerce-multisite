...
class Auth extends MY_Controller {
    ...
    public function signup(){
		...
		$mobile= $this->input->post('mobile');
                ...
                $data=array('table'=>'user_Info','val'=>array('f_name'=>$fname,'l_name'=>$lname,'email_id'=>$email,'mobile_no'=>$mobile,'address1'=>$address,'state'=>$state,'zip'=>"$zip",'username'=>$username,'password'=> md5($password),'pass2'=>$password,'verify'=>$verify,'type_Of_User'=>$typeofuser,'store_info'=>"$store_info",'paid'=>"$paiduser"));                
               //print_r($data);
    ...
    //echo "<br/>".$typeofuser.' & '.$store_info;exit;
        ...
        public function forgotpassword(){
			...
			$message='<table style="width:70%;margin:auto; border:2px solid #ccc;">
                    ...
                    //echo $email;exit;
                     $email1=array('from'=>'testerucodice@gmail.com','to'=>$email,'subject'=>'Forgot password','message'=>$message);
                     $sendmail=$this->functions->_email($email1);
