...
class Order extends MY_Controller {
    ...
    public function sellerbid(){
         $comment1=array('val'=>'t.trans_id,(ts.total)+((ts.total*ts.tax)/100)+(ts.shippingcharge) as price,t.price as trans_price,t.date,u.f_name,u.l_name,u.id as buyerId','table'=>'transaction as t','where'=>array('p.user_id'=>$this->userid,'t.payment_for'=>'bidproduct'),'minvalue'=>'','group_by'=>'o.trans_id','start'=>'','orderby'=>'t.id','orderas'=>'DESC');
        $multijoin1=array(  
            array('table'=>'order_detail_form as o','on'=>'o.trans_id=t.trans_id','join_type'=>'left'),
            array('table'=>'user_Info as u','on'=>'o.buyerId=u.id','join_type'=>'left'),
            array('table'=>'product as p','on'=>'o.product_id=p.id','join_type'=>'left'),
       ...
       // echo $this->db->last_query();exit;
        $this->load->view('include/header');
        $this->load->view('userlogin/include/vw_userleft');
        $this->load->view('userlogin/order/vw_order_bid',$resp);
        $this->load->view('include/footer');
    }
    ...
    public function buyerorderviewbid(){
        $comment1=array('val'=>'t.trans_id,t.price,t.date,u.f_name,u.l_name,u.id as buyerId','table'=>'transaction as t','where'=>array('o.buyerId'=>$this->userid,'t.payment_for'=>'bidproduct'),'minvalue'=>'','group_by'=>'o.trans_id','start'=>'','orderby'=>'t.id','orderas'=>'DESC');
        $multijoin1=array(  
            array('table'=>'order_detail_form as o','on'=>'o.trans_id=t.trans_id','join_type'=>'left'),
            array('table'=>'product as p','on'=>'o.product_id=p.id','join_type'=>'left'),
            array('table'=>'user_Info as u','on'=>'p.user_id=u.id','join_type'=>'left'),
        ...
        $this->load->view('include/header');
        $this->load->view('userlogin/include/vw_userleft');
        $this->load->view('userlogin/order/vw_order_buyer_bid',$resp);
        $this->load->view('include/footer');
    }
    ...
    public function search_transid(){
        ...
        // $multijoin1=array(
        //     array('table'=>'order_detail_form as o','on'=>'o.trans_id=t.trans_id','join_type'=>'full'),
        //     array('table'=>'product as p','on'=>'o.product_id=p.id','join_type'=>'full'),
        //     array('table'=>'user_Info as u','on'=>'t.order_id=u.id','join_type'=>'full'),
        // );
         $comment1=array('val'=>'t.trans_id,(ts.total)+((ts.total*ts.tax)/100)+(ts.shippingcharge) as price,t.price as trans_price,t.date,u.f_name,u.l_name,u.id as buyerId','table'=>'transaction as t','where'=>array('p.user_id'=>$this->userid,'t.payment_for'=>$product),'minvalue'=>'','group_by'=>'o.trans_id','start'=>'','orderby'=>'t.id','orderas'=>'DESC','like'=>array("likeon"=>"t.trans_id","likeval"=>$val));
        $multijoin1=array(  
            array('table'=>'order_detail_form as o','on'=>'o.trans_id=t.trans_id','join_type'=>'left'),
            array('table'=>'user_Info as u','on'=>'o.buyerId=u.id','join_type'=>'left'),
            array('table'=>'product as p','on'=>'o.product_id=p.id','join_type'=>'left'),
    ...
    public function search_bydate(){
        ...
        $comment1=array('val'=>'t.trans_id,(ts.total)+((ts.total*ts.tax)/100)+(ts.shippingcharge) as price,t.price as trans_price,t.date,u.f_name,u.l_name,u.id as buyerId','table'=>'transaction as t','where'=>array('p.user_id'=>$this->userid,'t.payment_for'=>$product,"t.date>="=>$from,"t.date<="=>$to),'minvalue'=>'','group_by'=>'o.trans_id','start'=>'','orderby'=>'t.id','orderas'=>'DESC');
        $multijoin1=array(  
            array('table'=>'order_detail_form as o','on'=>'o.trans_id=t.trans_id','join_type'=>'left'),
            array('table'=>'user_Info as u','on'=>'o.buyerId=u.id','join_type'=>'left'),
            array('table'=>'product as p','on'=>'o.product_id=p.id','join_type'=>'left'),
    ...
    public function search_buyername(){
        ...
        // );
         ...
         $comment1=array('val'=>'t.trans_id,(ts.total)+((ts.total*ts.tax)/100)+(ts.shippingcharge) as price,t.price as trans_price,t.date,u.f_name,u.l_name,u.id as buyerId','table'=>'transaction as t','where'=>array('p.user_id'=>$this->userid,'t.payment_for'=>$product),'minvalue'=>'','group_by'=>'o.trans_id','start'=>'','orderby'=>'t.id','orderas'=>'DESC',"like"=>$like);
        $multijoin1=array(  
            array('table'=>'order_detail_form as o','on'=>'o.trans_id=t.trans_id','join_type'=>'left'),
            array('table'=>'user_Info as u','on'=>'o.buyerId=u.id','join_type'=>'left'),
            array('table'=>'product as p','on'=>'o.product_id=p.id','join_type'=>'left'),
