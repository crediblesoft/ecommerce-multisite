...
<!--    <style type="text/css">
    ...
    <div class="row">
        ...
        <div class="top-header">
            ...
            <div class="col-sm-8 col-md-8 col-lg-9 col-xs-12 padng_tp_10 padlft">
            ...
            <div class="col-sm-4 col-md-4 col-lg-3 col-xs-12 margauto padng_tp_10 padng_btm_10 cartflotrt">
                <?php if($this->session->userdata("user_type")==2 || (!$this->session->has_userdata("user_type"))){ ?>
                    <div class="row col-sm-4 margauto cart_main">
        ...
        <div class="col-sm-12 col-md-12 col-lg-10  col-lg-offset-1">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
              ...
              <a class="row navbar-brand" href="<?=BASE_URL?>"><img src="<?=BASE_URL?>assets/image/logo.png" class="img-responsive logo_img2"></a>
          </div>
          <div id="navbar" class="navbar-collapse collapse custom-collapse">
            <ul class="nav navbar-nav cus-left-nav marg">
              <li <?php if(in_array('home',$menu)){ ?> class="active" <?php } ?> ><a href="<?=BASE_URL?>">Home</a></li>
              <li <?php if(in_array('aboutus',$menu)){ ?> class="active" <?php } ?> ><a href="<?=BASE_URL?>aboutus/">About us</a></li>
              <li class="dropdown dropdown-submenu <?php if(in_array('businesstypenames',$menu)){ ?>active <?php } ?>"><a href="#" class="dropdown-toggle " data-toggle="dropdown">Businesses &nbsp;<b class="caret"></b></a>
...
<?php
	      ...
	      <li <?php if(in_array('recipe',$menu)){ ?> class="active" <?php } ?> ><a href="<?=BASE_URL?>recipe/">Recipes</a></li>
              <?php /*<li><a href="<?=BASE_URL?>termsconditions/">Terms & conditions</a></li>*/?>
              <li <?php if(in_array('campaign',$menu)){ ?> class="active" <?php } ?> ><a href="<?=BASE_URL?>campaign/">Support A Farm</a></li>
              <li <?php if(in_array('contactus',$menu)){ ?> class="active" <?php } ?> ><a href="<?=BASE_URL?>contactus/">Contact</a></li>
            </ul>
