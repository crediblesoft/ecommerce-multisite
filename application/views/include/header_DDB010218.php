        ...
        <div class="col-sm-12 col-md-12 col-lg-10  col-lg-offset-1">
          ...
          <div id="navbar" class="navbar-collapse collapse custom-collapse">
            <ul class="nav navbar-nav cus-left-nav marg">
              ...
              <li class="dropdown dropdown-submenu <?php if(in_array('products',$menu)){ ?>active <?php } ?>"><a href="#" class="dropdown-toggle " data-toggle="dropdown">Products &nbsp;<b class="caret"></b></a>
