...
<div class="row footer">
    <div class="container">
        <div class="row">
             <div class="col-sm-12 col-md-8 col-lg-8 col-xs-12 foot1 margin-bottom_20 padlr0">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12 pull-right margin-bottom_10 padd20"> 
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 margin-bottom_10 social_head">
                    <ul class="social">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 news_letter_subs ">
        ...
        <div class="row margin-bottom_20 text_center">
            <div class="copy" style="margin-left:57px;">&copy; copyright - All Rights Reserved</div>
            <div class="ucodice"  style="margin-left:57px;"> Website Designed & Developed by <a href="http://www.ucodice.com/" target="_blank"> Ucodice.com</a></div>   
        </div>
        </div>  
    </div>
</div>
 ...
 <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Send this message without a subject or text in the body?</p>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger btn-ok" id="yes_form">Yes</a>
                </div>
            </div>
        </div>
    </div>  
...
<script> 
    $(document).ready(function(){
        $("#news_susc").click(function(){
            ...
            if(!isValidEmailAddress(news_email)){
                ...
                $(".news_email").focus();
                $(".news_email_error").parent().addClass("has-error");
                $(".news_email_error").html("Please enter valid email address.");
                return false;
            }
    ...
    function getmessagecount(){
        ...
        $.ajax({
                async:false,
                type:'POST',
                url: '<?=BASE_URL?>message1/get_all_count',
                data: {},
