<style>
<?php $last_segment  =  $this->uri->segment(3);
if ($last_segment!="user_profile"){ ?>
  #menu-line{
  display: none;
}
  <?}?>
...
echo  $this->uri->segment(3);
 ?> {
  border-top: 3px solid #E13300 !important;
 }
 .<?php 
echo  $this->uri->segment(3);
 ?> > a{
...
<?php if(!$this->session->userdata('user_id')){ ?>
        <ul class="nav navbar-nav navbar-right cus-right-nav" style="margin-top:10px;">
          ...
          <li>
            <a class="margin_top_7" href="<?php echo BASE_URL."products/viewcart"?>">
              ...
              <?php } } ?>
                  ...
                  <?php if((!$user_edit_panel)){?>
                   <li class="btn-group  cus-right-nav1">   
                    <button type="button" class="btn btn-default dropdown-toggle margin_top_17" data-toggle="dropdown">
                       <img src="<?=BASE_URL?>assets/image/user/thumb/<?=$this->session->userdata('user_image')?>" height="30" width="30" class="img-circle"> <span class="caret"></span>
                        ...
                        <ul class="dropdown-menu" role="menu">
                           ...
                           <li><a href="<?=BASE_URL?>usereditpenal">Customize My Site</a></li>
                               <?php } ?>
...
var logolink11=$("#cssmenu").find("ul > li:first a").attr("href");
$("#userlogo").attr("href",logolink11);
</script>
<?php     
    }
    else
