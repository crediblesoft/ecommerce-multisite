        ...
        <div class="compare">
            ...
            <div class="col-sm-2 col-lg-2 col-md-2 col-xs-6" id="com_<?=$compared_product->id?>">
                ...
                <div class="compare_border">
                    ...
                    <p class="text-center compare_prod_name"><a href="#" ><?=$compared_product->prod_name?></a></p>
                </div>
            </div>
            <?php } } ?>
...
<!--                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <p class="col-sm-3 col-lg-3 col-md-3 col-xs-12 prod_vw_filters_head">Filter By </p>
            
            <div class="col-sm-9 col-lg-9 col-md-9 col-xs-9 product_buy_btn">
                <div class="product_vw_type_btn pull-right">    

                    <ul><li><a href="javascript:void(0);" class="bid_filter" id="bid_0">Buy Directly</a></li>
                        <li><a href="javascript:void(0);" class="bid_filter" id="bid_1">Bid</a></li></ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="thumbnail product_cus_thumb">
                       ...
                       <div class="col-sm-12 col-xs-12">
                           ...
                           <div class="row margin-bottom_10">
                               ...
                               <div class="col-sm-5 col-xs-5 product_vw_price" title="<?=$product->business_name?>"> <?php echo substr($product->business_name,0,9);if(strlen($product->business_name)>9){echo "...";}?> </div>
                           </div>
                           <?php }else{ ?>
                           <div class="row margin-bottom_10">
        ...
        function(data,status){
           ...
           if(obj.products.res){
                ...
                $.each(obj.products.rows,function(i,val){
                    ...
                    if(val.business_name.length > 9){ var dot2='...'; }else{ var dot4=''; }
                    ...
                    htm+='<div class="col-sm-5 col-xs-5 product_vw_price" title="'+val.business_name+'">'+val.business_name.substr(0,9)+''+dot4+'</div>';
                    htm+='</div>';
                    }else{
                    htm+='<div class="row margin-bottom_10">';
