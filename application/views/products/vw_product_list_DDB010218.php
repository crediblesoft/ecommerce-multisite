...
<script>
  ...
  /*$(document).on("click",".size-filter",function(){
    ...
    function filterdata(){
        ...
        {by:'category',productname:productname,business_name:business_name,currentpage:currentpage,size:filter_size,min_price:min_price,max_price:max_price,certification:certification,categoryid:categoryid,zipcode:zipcode,bid:bid_filter,seller_ratting:seller_ratting},
