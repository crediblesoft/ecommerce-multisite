...
<div class="row">
    <div class="col-sm-10 col-md-10 col-lg-10 col-xs-12 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
        ...
        <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12 ">
            ...
            <form class="" id="authrizepaymentform" role="form" enctype = 'multipart/form-data'  method="post" action="<?=BASE_URL?>braintree/Braintreecontroller/index/" >
                    <!--auth/review-->
                    ...
                    <div class="" id="payinfo" style="display: block;">
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                                ...
                                <input type="text" placeholder="Name on card" name="name_on_card" id="name_on_card" class="form-control" value="<?=set_value('name_on_card')?>">
                                <?php
