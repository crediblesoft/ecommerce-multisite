...
//echo  $crt_id=$this->input->post('ads_id');
//print_r($str);
...
<div class="row">
    <div class="col-sm-10 col-md-10 col-lg-10 col-xs-12 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
        ...
        <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12 ">
            ...
            <form class="" id="authrizepaymentform" role="form" enctype = 'multipart/form-data'  method="post" action="<?=BASE_URL?>authorizepayment/Authorizecontroller/index/" >
                    <!--auth/review-->
...
<!--                            <input type="radio" checked="checked" value="2" id="paypal" name="paytype">
                            Your Paypal Account-->
                            <input type="radio"  checked="checked" value="1" id="credit" class="paytype"  name="paytype"> 
                            Using Credit Card
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="input-group">
                    ...
                    <div class="" id="payinfo" style="display: block;">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearfix margin-bottom_30">
...
<script>
    $('#credit_card_no').bind('keyup blur',function(){ 
        var credit_card_no = $("#credit_card_no").val().trim();
        if(!$.isNumeric( credit_card_no ))
            $("#credit_card_no_error").parent().addClass("has-error");
