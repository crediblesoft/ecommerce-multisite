...
<div class="col-sm-9">
            ...
            <div class="rows box-header margin-top_20 custom_lft_margin">
			  ...
			  <option value="buyer_username" <?php if($this->input->get('searchby')=='buyer_username'){echo "selected";} ?> >By Buyer's Username</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control search_form_display" id="product" name="val" placeholder="Transaction Id" disabled="" autocomplete="off" required="">
                    </div>
