                    ...
                    <ul class="media-list">
                        <li class="media">
                            <div class="media-body" id="conservation-user">
                                ...
                                ?>
                                <div class="media users-with" id="<?=$userdata->id?>" onClick="reply_click(this.id)">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div id="check">
                                        <input type="hidden" class="value" name="" value="<?=ucfirst($userdata->first_name).' '.ucfirst($userdata->last_name)?>">
                                        </div>
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="glyphicon glyphicon-comment"></span> MESSAGE'S &nbsp;<strong> <span id="currentchatusername"><?php if($currentusername!=''){ echo "to <strong>".$currentusername."</strong>"; } ?></span></strong>
...
// var ans =    $('.value').val();
// alert(ans);
//     $('#currentchatusername').html(ans);

    function reply_click(clicked_id){
         var ans=$('#'+clicked_id).find('.value').val();
         $('#currentchatusername').html(ans);

         // $('#'+clicked_id).load(function() {
         //    $('#currentchatusername').html(ans);
         //      alert("hey");
         //    });
     }
