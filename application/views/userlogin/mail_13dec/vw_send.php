    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="cus_mail_panel_heading">
                ...
                <div class = "input-group">
                    <input type = "hidden" class = "form-control" name="page" value="send">
                    <input type = "text" class = "form-control" id="search" name="search" placeholder="Recipient">
                    <span class = "input-group-btn">
                        <button class = "btn btn-default" id="send_search" type = "submit"> <span class="glyphicon glyphicon-search"></span></button>
                    </span>
                </div>
                </form>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr >
                         <td width='5%'><input type="checkbox" value="<?=$inbox->mail_id?>" class="innercheckbox"></td>
                           <td width='25%' class='clickable-row' data-href="<?=BASE_URL?>mail/senddetail/<?=$inbox->mail_id?>" title="click to view" ><?php echo substr($inbox->subject,0,40); ?></td>
                          <td width='45%' class='clickable-row' data-href="<?=BASE_URL?>mail/senddetail/<?=$inbox->mail_id?>" title="click to view" ><?php echo substr($inbox->tofirstname,0,40); if(strlen($inbox->tofirstname)>40){echo "...";} ?></td>
                          <td width='20' class='clickable-row' data-href="<?=BASE_URL?>mail/senddetail/<?=$inbox->mail_id?>" title="click to view"><?=date('Y-m-d',$inbox->timestamp)?></td>
                          <td width='5%' class='clickable-row' data-href="<?=BASE_URL?>mail/senddetail/<?=$inbox->mail_id?>" title="click to view" ><?php if($inbox->attach){ ?> <i class="fa fa-fw fa-paperclip"></i> <?php } ?></td>
                       </tr>
                            <?php } } ?>
                    </tbody>
                 </table>
