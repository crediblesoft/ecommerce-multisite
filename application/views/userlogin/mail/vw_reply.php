            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?=BASE_URL?>mail/reply/<?=$replylist->mail_id?>" name="form" method="post"  class="form-horizontal" role="form" enctype = 'multipart/form-data'>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">     
                                  ...
                                  <input type="text" class="form-control" id="to" value="<?=$replylist->reply_to?>" name="to" placeholder="To" autocomplete="off">
