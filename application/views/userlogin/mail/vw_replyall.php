...
$allreplyuser=false;
if($replyall['res']){
foreach($replyall['rows'] as $replyalllist){
    $replyuserlist[]=$replyalllist->reply_to;
}
    $allreplyuser=true;
    $allreplyuser=implode(",",$replyuserlist);
}
?>
<div class="row">
...
<div class="col-sm-12">
    ...
    <div class="contant-head1 gredient_forum">
        ...
        <h4> <span class="glyphicon glyphicon-th" aria-hidden="true"></span>  Manage Mail </h4> <h5 class="margin_top_28"> > Reply </h5>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?=BASE_URL?>mail/replyall/<?=$replylist->mail_id?>" name="form" method="post"  class="form-horizontal" role="form" enctype = 'multipart/form-data'>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">     
                                  ...
                                  <input type="text" class="form-control" id="to" value="<?=$replylist->reply_to?><?php if($allreplyuser){echo ",".$allreplyuser;}?>" name="to" placeholder="To" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">          
                                  <input type="text" class="form-control" id="subject" value="Re:<?=$replylist->subject?>" name="subject" placeholder="Subject">
