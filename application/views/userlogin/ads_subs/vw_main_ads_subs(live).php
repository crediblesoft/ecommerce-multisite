...
<style>
    ...
    .bnr_img{float: right; margin-top: 10px;}
                    ...
                    <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>adssubscription/update_ads">
                        ...
                        <div class="" id="by_form">
                            ...
                            <div class="form-group">
                             ...
                             <div class="col-sm-2 bnr_img"><img src="<?=BASE_URL."assets/image/ads_images/thumb/".$adsdata['rows'][0]->image;?>" class="img-responsive"></div>
                             <?php } ?> 
