            ...
            $.post("<?=BASE_URL?>requirement/searchbycategory/",{category:category},function(data,status){
                ...
                if(obj.res){
                    ...
                    $.each(obj.rows,function(i,val){
                        ...
                        if(val.selleronline==1){
                            var buyername='Chat with'+' '+val.username;
                        }
                        else{
                            var buyername='Send Message'+' '+val.username;
                        }
                        ...
                        htm+='<p class="margin-bottom_10 requirement_text">'+val.details.substr(0, 300)+''+dot1+'</p><br>';
                        htm+='<p><span class="cust_span_1">Posted Date :-</span>'+val.req_date+'</p>'
                        ...
                        htm+='<a href="<?=BASE_URL?>message/'+val.buyer+'" class="btn btn-success chatwithonlineuser">'+buyername+'</a>'
