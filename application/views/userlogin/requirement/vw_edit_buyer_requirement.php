<?php //print_r($requirement)?>
<div class="col-sm-9">
            <div class="">
                <div class="">
                    <div class="contant-head">
                        <h4> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> <a href="<?=BASE_URL?>requirement">  Shopping List </a> </h4><h5> > edit </h5>
            ...
            <div class="contant-body1">
                <div class="">
                    <?php if($requirement['res']){ 
                            $requir=$requirement['rows'];
                        ?>
                    <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>requirement/update">
                        <input type="hidden" value="<?=$requir->id?>" name="id">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <select class="form-control" id="category" name="category">
                                    ...
                                    ?>
                                        <option value="<?=$category->id?>" <?php echo set_select('category', $category->id); ?> <?php if($category->id==$requir->cat_id){ echo "selected";} ?> ><?=$category->category?></option>
                                        <?php } } ?>
                                </select>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9"> 
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="price" value="<?=$requir->price?>" name="price" placeholder="Product Price" onkeyup="checknumber(this.id,this.value)" >
                                 </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">          
                                  <textarea class="form-control" id="details" name="details" placeholder="About Your Requirement"><?=$requir->details?></textarea>
                    ...
                    <?php }else{ ?> <p class="text-danger"> You are not authorized user for edit this post</p><?php } ?>
                </div>
            </div>
        </div>
