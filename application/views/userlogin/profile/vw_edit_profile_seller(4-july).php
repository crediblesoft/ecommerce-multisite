...
<div class="col-sm-9 col-lg-9 col-md-9 col-xs-12">
			...
			<ol>
                    ...
                    <div>  
                        ...
                        <div class="col-sm-6">
                            <img src="<?=BASE_URL?>edit_assets/image/theme1/01.png"  id="1001"  <?php if($theme['rows'][0]->theam_id=='1001'){  ?> style="border: 1px solid rgb(255, 24, 24);box-shadow: 0px 0px 16px 0px rgb(219, 11, 11);" <?php } ?> class="img img-responsive theme">
                        </div>
                            
                            
                        <div class="col-sm-6">
                            <img src="<?=BASE_URL?>edit_assets/image/theme2/01.png"  id="1002"  <?php if($theme['rows'][0]->theam_id=='1002'){  ?> style="border: 1px solid rgb(255, 24, 24);box-shadow: 0px 0px 16px 0px rgb(219, 11, 11);"  <?php } ?>  class="img img-responsive theme"> 
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <?php if($businesstype['res']){ foreach($businesstype['rows'] as $businesstype1){ ?>
                                                <option value="<?=$businesstype1->id?>" <?php if(in_array($businesstype1->id,$userbusinesstype1)){echo "selected";}?> ><?=ucfirst($businesstype1->category)?></option>
                                            <?php }} ?>
                                            </select>    
                                        </div>
