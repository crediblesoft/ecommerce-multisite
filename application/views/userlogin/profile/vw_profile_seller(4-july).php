                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <?php if($businesstype['res']){ foreach($businesstype['rows'] as $businesstype1){ ?>
                                                <option value="<?=$businesstype1->id?>" <?php echo set_select('business_type', "$businesstype1->id"); ?>><?=ucfirst($businesstype1->category)?></option>
                                            <?php }} ?>
                                            </select>    
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">          
                                            <input type="text" class="form-control" id="acno" value="<?=set_value('acno')?>" name="acno" placeholder="Account Number" onkeyup="checknumber(this.id,this.value)">
