            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                ...
                <a href="<?=BASE_URL?>mail/trash" class="btn btn-success btn-sm">Trash Mail</a>
                    ...
                    <div class="panel-body">
                        <form action="<?=BASE_URL?>mail/createnew" name="form" method="post"  class="form-horizontal" role="form" enctype = 'multipart/form-data'>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">     
                                  ...
                                  <input type="text" class="form-control" id="to" value="<?=set_value('to')?>" name="to" placeholder="To" autocomplete="off">
