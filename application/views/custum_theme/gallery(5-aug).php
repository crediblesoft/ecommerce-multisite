...
/*        #galary_portfolio>li:hover{
        ...
        .no_gal{font-size: 26px;cursor: pointer;}
</style>
...
<!--                    <a class="">
                        <img class="img-responsive  center-block" src="<?php echo BASE_URL.'assets/image/gallery/'.$session_user_id.'/thumb/'.$galary['image_path'];?>" alt="image" >
                    </a>                    -->
                    ...
                    <!--<div class="block "><?php //echo $galary['type_ofimage'].'Image';?></div>-->
                </li>
                <?php }}else{ 
                    
                    /*for($i=1;$i<=4;$i++){?>
                <li class="col-xs-6 col-sm-4 col-md-3 col-lg-3">                    
                    <a><img class="img-responsive" src="<?php echo  BASE_URL.'edit_assets/image/0'.$i.'.jpg';?>" alt="image" ></a>                    
                    <div class=" block "><?php echo 'Demo Image';?></div>
                </li>
                <?php } */
                    if($user_edit_panel){ ?>
