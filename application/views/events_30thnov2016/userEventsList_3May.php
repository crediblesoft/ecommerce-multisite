...
<div class="col-sm-9">
            ...
            <div class="contant-body2">
				  ...
				  echo '<a target="_blank" style="float:left;width:45%" class="fbshare" title="Share On Facebook" onclick="window.open(\'https://www.facebook.com/dialog/feed?curi=close&app_id='.$fb_app_id.'&display=popup&ref=share&picture='.$img_paath.'&name='.$title.'&description='.$summary.'&link='.$list_url.'&redirect_uri='.$rurl.'\',\'sharer\',\'toolbar=0,status=0,width=548,height=325\');return false;" href="javascript: void(0)" ><img class="img img-responsive" id="fb-share" src = "'.BASE_URL.'assets/image/fbshare.png" alt="fbshare"></a>';
				  echo '<a target="_blank" style="float:left;width:45%;" title="Share On Twitter" onclick="window.open(\'https://twitter.com/share?text='.$textfortwitter.'&url='.$list_url.'&utm_source=ProductDetailPage&utm_medium=Twitter\',\'_blank\', \'location=yes,width=700,height=400\');return false;" href="https://twitter.com/share?text='.$textfortwitter.'&url='.$list_url.'&utm_source=ProductDetailPage&utm_medium=Twitter"><img class="img img-responsive" src = "'.BASE_URL.'assets/image/twittershare.png" alt="fbshare"></a>';
				  echo '</div>';
					?>			   
					<script> 
					window.open('', '_self', ''); 
