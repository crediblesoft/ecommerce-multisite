<div class="row">
        ...
        <div class="signup">
            ...
            <div class="col-xs-12">
                ...
                <div class="form-group required">                  
                    <label for="inputFname" class="control-label">First Name</label><span>(Please enter alphabets only)</span>
                ...
                <div class="col-sm-6">
                <div class="form-group required">                  
                    <label for="inputLname" class="control-label">Last Name</label><span>(Please enter alphabets only)</span>
 ...
 <div class="col-xs-12">
                 <div class="col-sm-6">
                <div class="form-group required">                  
                    <label for="inputCpassword" class="control-label">City</label>
     ...
     // alert(mobile.length);
      ...
      if(email == ''){
        ...
        if(!validateEmail(email)){
            $("#email").focus();
            $("#email_error").html("Enter valid a email-id");
            $("#email_error").parent().addClass("has-error");
            return false;
        }
      }
      ...
      if(mobile.length !== 10){
            $("#mobile_error").html("Enter a valid 10-digit mobile number");
            $("#mobile").focus();
            $("#mobile_error").parent().addClass("has-error");
            return false;    
      }
      ...
      if(!$("#agree").is(':checked')){
          $("#agree_error").html("Please agree with terms & conditions");
            $("#agree").focus();
...
function validateEmail(sEmail) {
    ...
    function checkpassword(){
        ...
        if(password!==cpassword){
            $("#password_error").parent().addClass("has-error");
            $("#cpassword_error").parent().addClass("has-error");
            $("#cpassword_error").html("Password must be same");
        }else{
