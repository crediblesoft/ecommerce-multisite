            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered">
                <tbody>
                    <tr> 
                        <th>User Name</th>
                        <td  colspan="3"><a href="<?=BASE_URL?>admin/users/details/<?=$campaigns['rows'][0]->user_id;?>" target="_blank" ><?=$campaigns['rows'][0]->username;?></a></td>
                    </tr>
                    <tr> 
                        <th>Title</th>
                        <td colspan="3"><?=$campaigns['rows'][0]->campaign_titel;?></td>
                    </tr>
                    <tr> 
                        <th>Details</th>
                        <td colspan="3"><?=$campaigns['rows'][0]->campaign_detail;?></td>
                    </tr>
                    <tr> 
                        <th>Price</th>
                        <td colspan="3">$<?=$campaigns['rows'][0]->price;?></td>
                    </tr>
                    <tr> 
                        <th>Start Date</th>
                        <td colspan="3"><?=$campaigns['rows'][0]->start_date;?></td>
                    </tr>
                    <tr> 
                        <th>End  Date</th>
                        <td colspan="3"><?=$campaigns['rows'][0]->end_date;?></td>
                    </tr>
                    
                    <tr> 
                        <th>User Status</th>
                        <td colspan="3"><?php if($campaigns['rows'][0]->show_stetus==1){echo "Active";}else{echo "In-Active";}?></td>
                    </tr>
                    <tr> 
                        <th>Admin Status</th>
                        <td colspan="3"><?php if($campaigns['rows'][0]->stetus==1){echo "Active";}else{echo "In-Active";}?></td>
                    </tr>
                     <?php 
                    ...
                    <tr>
                        ...
                        <th colspan="3">Pay out Amount</th>
                    </tr>
                    <tr>
                        <td>$<?php echo $totalamt; ?></td>
                        <td>$<?php echo $totatcomm; ?></td>
                        <td colspan="3">$<?php echo $totalamt-$totatcomm; ?></td>
                    </tr>
                    <?php }else{?>
                        <tr>
                    ...
                    <tr class="campaign-donate-detail"> 
                        <th class="text-center" width="25%">Transaction Id</th>
                        <th class="text-center" width="25%">Paid Donors</th>
                        <th class="text-center" width="25%">Paid Amount</th>
			<th class="text-center" width="25%">Paid Date</th>
                    </tr>
                       <?php 
                       //print_r($peymentdetail); exit;
                        if($peymentdetail['res']){
