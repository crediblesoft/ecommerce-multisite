            ...
            <div class="box-header with-border">
			  ...
			  <option value="paiduser" <?php if($this->input->get('searchby')=='paiduser'){echo "selected";} ?> >By Paid Donors</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control search_form_display" id="product" name="val" placeholder="Campaign Title" disabled="">
                    </div>
                      <div class="form-group">
...
<!--                    <div class="form-group"> &nbsp;
					 ...
					 <div class="form-group">
                        <label for="pwd" class="sr-only">Product Name</label>
                        <input type="text" class="form-control search_form_display" id="paiduser" name="val" placeholder="Paid Donors" disabled="">
                    </div>
