...
<!--                    <a href="<?=BASE_URL?>admin/vs/add" class="btn btn-success btn-sm" id=""><span class="glyphicon glyphicon-plus-sign"></span> Add Category</a>-->
                    ...
                    <a href="<?=BASE_URL?>admin/events/addevent" class="btn btn-success btn-sm" id="" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Events_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>>Add Event</a>
                    <a href="javascript:void(0)" class="btn btn-warning btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Events_enable')!='1'){echo '" disabled ';}?> featured" id="">Active</a>
                    <a href="javascript:void(0)" class="btn btn-primary btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Events_enable')!='1'){echo '" disabled ';}?> un_featured" id="">In-Active</a>
                    <a href="javascript:void(0)" class="btn btn-danger btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Events_modifiable')!='1'){echo '" disabled ';}?> delete" id="">Delete</a>
                </div>
                </form>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-primary btn-sm" title="View event" href="<?=BASE_URL?>admin/events/view_event/<?=$eventslist->id;?>">
                            ...
                            <?php if($eventslist->username ==""){ ?>
                            <a class="btn btn-warning btn-sm" title="Edit event" href="<?=BASE_URL?>admin/events/editevent/<?=$eventslist->id;?>" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Events_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>>
