    ...
    <div class="row">    
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/promotion/add">
                        
                        
                <div class="form-group">
                    <div class="col-sm-2 col-sm-offset-1"><label class="control-label" for="name">Promotion Code</label></div>
                  <div class="col-sm-9">          
                      <input type="text" class="form-control" id="code" value="<?php if(set_value('code')!=''){echo set_value('code');}else{echo $random;}?>" name="code" placeholder="Random Number" maxlength="30">
                      <?php if(form_error('code')!='') echo form_error('code','<div class="text-danger err">','</div>'); ?>
                  <span class="lmt_msg">(* Maximum 30 charater only accpeted.)</span>   
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9" style="z-index:999">          
                      <input type="text" class="form-control" id="startdate" value="<?=set_value('startdate')?>" name="startdate" placeholder="Valid From">
...
<!--                <div class="form-group">
                  ...
                  <div class="col-sm-9" style="z-index:999">          
                      <input type="text" class="form-control" id="enddate" value="<?=set_value('enddate')?>" name="enddate" placeholder="Valid To">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9" style="z-index:999">          
                      <select class="form-control" id="enddate" name="enddate">
                            ...
                            <option value="3" <?php echo set_select('enddate','0'); ?> >3 Months</option>
                            <option value="6" <?php echo set_select('enddate','1'); ?> >6 Months</option>
                            <option value="12" <?php echo set_select('enddate','2'); ?> >1 Year</option>
                      </select>
                      <?php if(form_error('enddate')!='') echo form_error('enddate','<div class="text-danger err">','</div>'); ?>
                  </div>
                  <span class="text-danger" id="enddate_error"></span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" class="form-control" id="admin_comm" value="<?=set_value('admin_comm')?>" name="admin_comm" placeholder="Discount" onkeyup="checknumber(this.id,this.value)">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <select class="form-control" id="users" name="users[]" multiple="">
                        ...
                        <option value="<?=$user->id?>" <?php echo set_select('status', $user->id); ?> ><?=$user->username?></option>
                        <?php }} ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">        
                  ...
                  <div class="col-sm-9">
                      <button type="submit" id="add_category" class="btn btn-primary pull-right" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_modifiable')!='1'){echo 'disabled';}?> >Submit</button>
                  </div>
                </div>
