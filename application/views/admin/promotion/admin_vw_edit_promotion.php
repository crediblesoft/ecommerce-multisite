            ...
            <div class="box-body">
              <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/promotion/edit/<?=$promotiondata->id?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">          
                      <input type="text" class="form-control" id="code" value="<?php if(set_value('code')!=''){echo set_value('code');}else{echo $promotiondata->code;}?>" name="code" placeholder="Random Number" maxlength="30">
...
<!--                <div class="form-group">
                ...
                <div class="form-group">        
                  ...
                  <div class="col-sm-9">
                      <button type="submit" id="add_category" class="btn btn-primary pull-right" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_modifiable')!='1'){echo 'disabled';}?>>Update</button>
                  </div>
                </div>
