        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="<?=BASE_URL?>admin/promotion/add" class="btn btn-success btn-sm" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>><span class="glyphicon glyphicon-plus-sign"></span> Add Promotion Code</a>
              </div>
              ...
              <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="javascript:void(0)" class="btn btn-success btn-xs <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_enable')!='1'){echo '" disabled ';}?> featured" id="<?="ac_".$product->id?>">Active</a></td>
                      <td><a href="javascript:void(0)" class="btn btn-danger btn-xs <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_enable')!='1'){echo '" disabled ';}?> un_featured" id="<?="ina_".$product->id?>">In-Active</a></td>
...
<!--                      <td style="width: 6px">
                          ...
                          <a href="<?=BASE_URL?>admin/promotion/edit/<?=$product->id?>" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_modifiable')!='1'){echo 'disabled onClick="return false;"';}?> class="btn btn-warning btn-sm" title="Edit promotion"><span class="glyphicon glyphicon-pencil"></span></a>
                          <?php } ?>
                      </td>-->
                    ...
                    <tr>
                        <td colspan="11">
                            <div class="pull-right">
                                <a href="<?=BASE_URL?>admin/promotion/add" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Promotion Code_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>   class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus-sign"></span> Add Promotion Code</a>
