          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="pull-right">
                ...
                <a href="<?=BASE_URL?>admin/forum/add" class="btn btn-warning btn-sm" id="" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Forum Category_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>><span class="glyphicon glyphicon-plus-sign"></span> Add Category</a>
            </div>
            </div>
            ...
            <div class="box-body">
              <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/forum/updatecategory">       
                ...
                <div class="form-group">        
                  ...
                  <div class="col-sm-9">
                      <button type="submit" id="add_category" class="btn btn-primary pull-right" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Forum Category_modifiable')!='1'){echo 'disabled';}?>>Update</button>
                  </div>
                </div>
