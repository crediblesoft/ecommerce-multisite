            ...
            <div class="box-body">
              <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/forum/addreply/<?=$forums->ForumId?>">
                ...
                <div class="form-group">        
                  ...
                  <div class="col-sm-9">
                      <button type="submit" id="add_category" class="btn btn-primary pull-right" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Forum_modifiable')!='1'){echo 'disabled';}?>>Submit</button>
                  </div>
                </div>
