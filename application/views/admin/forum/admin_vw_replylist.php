          ...
          <div class="box">
            <div class="box-header with-border">
                <div class="pull-right">
                    ...
                    <a href="<?=BASE_URL?>admin/forum/addreply/<?=$forumlist['rows'][0]->ForumId?>" class="btn btn-primary btn-sm" id="" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Forum_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>><span class="glyphicon glyphicon-plus-sign"></span> Add Reply</a>
                    ...
                    <a href="<?=BASE_URL?>admin/forum" class="btn btn-warning btn-sm" id="" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Forum Category')!='Manage Forum Category'){echo 'disabled onClick="return false;"';}?>><span class="glyphicon glyphicon-eye-open"></span> View Category</a>
                </div>  
            </div>
            <!-- /.box-header -->
