        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <form class="form-inline" role="form" action="<?=BASE_URL?>admin/forum/new_search/" method="get">
<!--                  <input type="hidden" name="pagename" value="<?php echo $pagename['pagename'];?>">
                ...
                <div class="pull-right">
                    <a href="<?=BASE_URL?>admin/forum/add" class="btn btn-success btn-sm" id="" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Forum Category')!='Manage Forum Category'){echo 'disabled onClick="return false;"';}?>><span class="glyphicon glyphicon-plus-sign"></span> Add Category</a>
