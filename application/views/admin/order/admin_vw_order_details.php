...
<!--                      <td><input type="checkbox" value="<?=$product->id?>" class="innercheckbox" name="id[]"></td>-->
                      ...
                      <td><a href="javascript:void(0)" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Order_modifiable')!='1'){echo 'disabled onClick="return false;"';}?> onClick="statuschange(<?=$product->id?>,<?=$product->status?>)" ><span class="glyphicon glyphicon-pencil"></span></a></td>
