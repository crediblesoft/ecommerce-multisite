            ...
            <div class="box-header with-border">
              ...
              <form class="form-inline" role="form" action="<?=BASE_URL?>admin/adssubscription/search" method="get">
                  <div class="pull-right">
                    <a href="javascript:void(0)" class="btn btn-warning btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Ads Subscription_enable')!='1'){echo '" disabled ';}?>  featured" id="">Active</a>
                    <a href="javascript:void(0)" class="btn btn-primary btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Ads Subscription_enable')!='1'){echo '" disabled ';}?> un_featured" id="">In-Active</a>
                 </div> 
