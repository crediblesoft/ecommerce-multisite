        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="<?=BASE_URL?>admin/Adscreate/add" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus-sign"></span> Add Ads</a>
              ...
              <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width: 6px"><a href="<?=BASE_URL?>admin/adscreate/update/<?=$ads->id?>" class="btn btn-warning btn-sm" title="Edit ads"><span class="glyphicon glyphicon-pencil"></span></a></td>
                    </tr>
