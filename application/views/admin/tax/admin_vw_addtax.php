...
<!--                <div class="form-group">
                ...
                <div class="form-group">        
                  ...
                  <div class="col-sm-9">
                      <button type="submit" id="add_category" class="btn btn-primary pull-right" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Tax_modifiable')!='1'){echo 'disabled';}?>>Submit</button>
                  </div>
                </div>
