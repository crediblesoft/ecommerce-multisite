...
<section class="content">
	...
	<div class="box-header with-border">
			...
			<div class="box-body">
                    <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/recipes/updaterecipe/">
                        <input type="hidden" id="recipeId" name="recipeId" value="<?=$recipe['rows'][0]->id?>" > 
                          ...
                          <img src="<?php echo $reciepe_image; ?>" width=150 alt="" class="img-responsive pull-right">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <select class="form-control" id="status" name="status">
                                        <option value="1" <?php if($recipe['rows'][0]->admin_status==1){echo "selected"; } ?> >Active</option>
                                        <option value="0" <?php if($recipe['rows'][0]->admin_status==0){echo "selected"; } ?> >Inactive</option>
                                </select>                                  
                              </div>
                            ...
                            <div class="form-group">        
                              <div class="col-sm-offset-9 col-sm-3">
                                  <button type="submit" id="recipebtn" class="btn btn-success btn-block" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Recipes_modifiable')!='1'){echo 'disabled';}?>>Update</button>
                              </div>
                            </div>
