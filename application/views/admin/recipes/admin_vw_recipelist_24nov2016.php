            ...
            <div class="box-header with-border">
              ...
              <form class="form-inline" role="form" action="<?=BASE_URL?>admin/recipes/search/<?php echo $this->uri->segment(4);?>/" method="get">
                ...
                <div class="pull-right">
                    <a href="<?=BASE_URL?>admin/recipes/add_new" class="btn btn-success btn-sm" id=""><span class="glyphicon glyphicon-plus-sign"></span> Add New Recipe</a>
              ...
              <table id="myTable" class="table table-bordered tablesorter">
                <thead>
                    ...
                    <tr>
                        ...
                        <?php if($category->userid==0){ ?>
						<td style="width: 6px">
                            <a class="btn btn-warning btn-sm" title="Edit recipe" href="<?=BASE_URL?>admin/recipes/editrecipe/<?=$category->recipeid?>">
