          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="pull-right">
                ...
                <a href="<?=BASE_URL?>admin/recipecat/add" class="btn btn-warning btn-sm" id=""><span class="glyphicon glyphicon-plus-sign"></span> Add Category</a>
            </div>
            </div>
              
            <div class="box-body">
              <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/recipecat/updatecategory">       
