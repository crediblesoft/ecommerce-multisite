...
<br>
                            ...
                            <div class="form-group">        
                              <div class="col-sm-offset-9 col-sm-3">
                                  <button type="submit" id="recipebtn" class="btn btn-success btn-block" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Recipes_modifiable')!='1'){echo 'disabled';}?>>Add</button>
                              </div>
                            </div>
                       </form>
					  </div>
...
//              }else
              if((details == '')){//The Recipe details field is required.
                    $("#details_error_nume").html("Recipe details is required field xzvxv");
                    $("#details").focus();
