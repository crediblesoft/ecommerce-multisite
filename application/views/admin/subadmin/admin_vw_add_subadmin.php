    ...
    <div class="row">    
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" role="form" enctype = 'multipart/form-data' method="post" action="<?=BASE_URL?>admin/subadmin/add">
                        
                        
                <div class="form-group">
                    <div class="col-sm-2 col-sm-offset-1"><label class="control-label" for="uname">Username</label></div>
                  <div class="col-sm-9">          
                      <input type="text" class="form-control" id="uname" value="<?php if(set_value('uname')!=''){echo set_value('uname');}?>" name="uname" placeholder="Username">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">          
                      <input type="text" class="form-control" id="fname" value="<?php if(set_value('fname')!=''){echo set_value('fname');}?>" name="fname" placeholder="First Name">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">          
                      <input type="text" class="form-control" id="lname" value="<?php if(set_value('lname')!=''){echo set_value('lname');}?>" name="lname" placeholder="Last Name">
                ...
                <div class="form-group">
                  <div class="col-sm-2 col-sm-offset-1"><label class="control-label" for="email">Security Role</label></div>
                  <div class="col-sm-9">
           <select class="form-control" id="security_role" name="security_role">
                                    <?php
                                        if($roles['res']){
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">          
                      <input type="text" class="form-control" id="email" value="<?php if(set_value('email')!=''){echo set_value('email');}?>" name="email" placeholder="Email id">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">          
                      <input type="password" class="form-control" id="password" value="<?php if(set_value('password')!=''){echo set_value('password');}?>" name="password" placeholder="Password">
