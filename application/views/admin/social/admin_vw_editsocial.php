        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="<?=BASE_URL?>admin/social/add" class="btn btn-warning btn-sm" id="" <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Social_modifiable')!='1'){echo 'disabled onClick="return false;"';}?>><span class="glyphicon glyphicon-plus-sign"></span> Add Social</a>
                </div>
            </div>
            <div class="box-body">
