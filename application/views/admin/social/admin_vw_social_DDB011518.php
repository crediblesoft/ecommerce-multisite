          ...
          <div class="box">
            <div class="box-header with-border">
                <div class="pull-right">
                    <a href="<?=BASE_URL?>admin/social/add" class="btn btn-success btn-sm" id=""><span class="glyphicon glyphicon-plus-sign"></span> Add Social</a>
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered">
               ...
               <tr>
                    ...
                    <td style="width: 6px"><a href="<?=BASE_URL?>admin/social/edit/<?=$category->id?>" class="btn btn-warning btn-sm" title="Edit category"><span class="glyphicon glyphicon-pencil"></span></a></td>
               </tr>
              <?php $i++;} ?>
