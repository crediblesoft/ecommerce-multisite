...
<!--                          <option value="name" <?php if($this->input->get('searchby')=='name'){echo "selected";} ?> >Name</option>
                ...
                <div class="pull-right">
                    <a href="javascript:void(0)" class="btn btn-warning btn-sm active1" id="">Active</a>
                     <a href="javascript:void(0)" class="btn btn-primary btn-sm in_active" id="">In-Active</a>
                    ...
                    <a href="javascript:void(0)" class="btn btn-warning btn-sm featured" id="">Featured</a>
                    <a href="javascript:void(0)" class="btn btn-primary btn-sm un_featured" id="">Un-Featured</a>
                    <?php }else{ ?>
                    <a href="<?=BASE_URL?>admin/buyer" class="btn btn-success btn-sm" id=""><span class="glyphicon glyphicon-eye-open"></span> Buyers</a>
