            ...
            <div class="box-header with-border">
                ...
                <div class="col-md-2 col-lg-2 col-sm-2">
                    <div class="pull-right">
                        <?php if(!$user->status){ ?>
                        <a href="javascript:void(0)" class="btn btn-warning btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Users_enable')!='1'){echo '" disabled ';}?> featured" id="">Active</a>
                        <?php }else{ ?>
                        <a href="javascript:void(0)" class="btn btn-primary btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Users_enable')!='1'){echo '" disabled ';}?> un_featured" id="">In-Active</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
 ...
 <?php }?>
			<?php if($user->paid==1 && $usertype=="Seller"){ ?>
                    <tr> 
						...
						<input type="button" value="update" id="exp_update_btn" class="btn btn-primary btn-sm " <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Users_modifiable')!='1'){echo 'disabled';}?>>
						</td>
                    </tr>  
                    <?php }?> 
                ...
                <?php if($user->type_Of_User==2){ if($datapenalty['res']){ ?>
                    ...
                    <tr> 
                        <th colspan="5">
                            <a href="javascript:void(0)" class="btn btn-danger btn-sm <?php if($this->session->userdata(ADMIN_SESS.'admin_type')!='1' && $this->session->userdata(ADMIN_SESS.'Manage Users_modifiable')!='1'){echo '" disabled ';}?> delete pull-right" id="">Delete</a>
                        </th>
                    </tr>
                    <tr>
