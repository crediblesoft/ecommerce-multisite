...
<!-- Left side column. contains the logo and sidebar -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">  
            <div class="col-lg-12">
                <form action="<?=ADMINBASE?>manage_testimonials/add" method="post" enctype="multipart/form-data">
                     ...
                     <div class="col-lg-12 padding-lftrght0">
                        <div class="col-lg-12 padding-lftrght0">
                            <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="event_title" data-validate="required" value="" class="form-control">
                    ...
                    <div class="col-lg-12 padding-lftrght0">
                        <div class="col-lg-12 padding-lftrght0">
                            <div class="form-group">
                                    ...
                                    <input type="text" name="designation" id="event_title" data-validate="required" value="" class="form-control">
                                    <div class="text-errror err"></div>
                     ...
                     <div class="col-lg-12 padding-lftrght0">
                        <div class="col-lg-12 padding-lftrght0">
                            <div class="form-group">
                                    ...
                                    <input type="text" name="experince" id="event_title" data-validate="required" value="" class="form-control">
                                    <div class="text-errror err"></div>
                    ...
                    <div class="col-lg-12 padding-lftrght0">
                        <div class="col-lg-12 padding-lftrght0">
                            <div class="form-group">
                                    ...
                                    <input type="file" name="file" id="event_title" data-validate="required" value="" class="form-control">
                                    <div class="text-errror err"></div>
                    ...
                    <div class="col-lg-12 padding-lftrght0">
                        <div class="col-lg-12 padding-lftrght0">
                            <div class="form-group">
                                    <label>Comment</label>
                                    <textarea type="text" name="comment" id="event_html"  value="" class="form-control" data-validate="required"></textarea>
                                    <div class="text-errror err"></div>
                ...
                <div class="col-lg-12 padding-lftrght0">
                        ...
                        <label class="radio-inline"><input type="radio" value="1" name="testimonial_status" style="top:-2px;"  id="option1" class="ui-wizard-content"><span>Active</span></label>
                    
                    
                        <label class="radio-inline"><input type="radio" value="2" name="testimonial_status" style="top:-2px;"  id="option1" class="ui-wizard-content"><span>In-Active</span></label>
                        </div>
